...
!endif
!ifndef OUTFILE
  !define OUTFILE "KitsuneTone-2.1.1-win64-setup.exe"
!endif

Name "狐Tone (KitsuneTone) 2.1.1"
OutFile "${OUTFILE}"
...
VIAddVersionKey /LANG=1041 "ProductVersion" "2.1.1"
VIAddVersionKey /LANG=1041 "FileVersion" "2.1.1"
...
Section "狐Tone" SecMain
  ...
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\KitsuneTone" "DisplayVersion" "2.1.1"
