...
!endif
!ifndef OUTFILE
  !define OUTFILE "KitsuneTone-2.1.0-beta-win64-setup.exe"
!endif

Name "狐Tone (KitsuneTone) 2.1.0-beta"
OutFile "${OUTFILE}"
...
VIAddVersionKey /LANG=1041 "ProductVersion" "2.1.0-beta"
VIAddVersionKey /LANG=1041 "FileVersion" "2.1.0-beta"
...
Section "狐Tone" SecMain
  ...
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\KitsuneTone" "DisplayVersion" "2.1.0-beta"
